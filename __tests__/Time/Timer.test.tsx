...
describe('Timer', () => {
  ...
  describe('without post process', () => {
    ...
    it('sets/gets progress', () => {
      ...
      expect(timerInstance.getTimeToCount()).toBe(900);
    ...
    it('returns fixed progress', () => {
      timerInstance.setProgress(0.19999999999999996);
      expect(timerInstance.getProgress()).toBe(0.2);
      timerInstance.setProgress(0.25555555555555556);
      expect(timerInstance.getProgress()).toBe(0.25556);
    });
