...
import Status from 'Beat/Status';
...
describe('Beat', () => {
  ...
  describe('General', () => {
    ...
    it('set/get tempo', () => {
      ...
      beatInstance.setTempo(120);
      expect(beatInstance.getTempo()).toBe(120);
    });
  });
    ...
    describe('Tempo increases', () => {
      ...
      describe('Mouseevent', () => {
        it('click 1 time / Running', () => {
          beat.find('.tapArea').simulate('click');
          clock.tick(2000);
    ...
    describe('Tempo decreases', () => {
      ...
      describe('Mouseevent', () => {
        ...
        it('click and finish', () => {
          ...
          expect(beatInstance.getState()).toBe(Status.Stopped);
          expect(spy.onAccelerate.callCount).toBe(60);
          expect(spy.onTick.callCount).toBe(61);
          expect(spy.onStart.callCount).toBe(1);
          expect(spy.onStop.callCount).toBe(1);
          expect(spy.onPause.callCount).toBe(0);
          expect(spy.onResume.callCount).toBe(0);
    ...
    describe(`Tempo doesn't change`, () => {
      ...
      describe('Mouseevent', () => {
        ...
        it('click and finish', () => {
          ...
          expect(beatInstance.getState()).toBe(Status.Stopped);
          expect(spy.onAccelerate.callCount).toBe(30);
